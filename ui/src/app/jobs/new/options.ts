...
export const modelArchs: ModelArch[] = [
  ...
  },
  {
    ...
    defaults: {
      ...
      'config.process[0].train.batch_size': [2, 1],
      'config.process[0].train.gradient_accumulation': [1, 1],
      'config.process[0].train.steps': [8000, 3000],
      ...
      'config.process[0].logging.monitor_every': [1, 10],
      'config.process[0].logging.monitor_tensor_stats': [true, true],
